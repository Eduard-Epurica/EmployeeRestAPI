...
public class EmployeeRestController {
    ...
    public Employee addEmployee(@RequestBody Employee theEmployee) {
        ...
        //also just in case they pass and id in JSON ... set the id to 0
    ...
    //add mapping for PUT /employees - updating an employee
    @PutMapping("/employees")
    public Employee updateEmployee(@RequestBody Employee updatedEmployee) {

        Employee dbEmployee = this.employeeService.save(updatedEmployee);
